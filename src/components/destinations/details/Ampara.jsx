          ...
          <div className="card-body">
            <p className="card-text">
              <h3>
                ...
                (Late 1890s and early 1900). During the development of the
                Galoya scheme from 1949, this was transformed into a town.
                {/* <br/><br/>
            <b>Top attractions in Ampara : </b> */}
              ...
              <h3 className="card-title">
                ...
                <h4>
                  Hidden among a thick jungle full of wild elephants and
                  leopards is the Buddhangala monastery, a Buddhist meditation
                  center, which is nearby 2300 years old. Established in the
                  secondary century BC by a provincial princess named, Chitra.
                </h4>
              </h3>
              ...
              <h3 className="card-title">
                <b>Wadinagala </b>
                <h4>
                  Stands 2400 feet tall challenging the brave and the reckless.
                  It is famed to be a mountain, one considered as an alternative
                  to bear the foot marks of the Lord Buddha and its heritage in
                  ancient Buddhism is visible in many ruins scattered around the
                  mountain. Beautiful guard stone s, rocks pillars and
                  moonstones lie amidst the towering forest of ebony and stain
                  wood, which is been plundered by treasure hunters and illegal
                  loggers.
                </h4>
              </h3>
              ...
              <h3 className="card-title">
                ...
                <h4>
                  ...
                  drip ledge caves, rock cut steps and ruins of ancient stupa
                  can be found on this rock.
                </h4>
              </h3>
              <h3 className="card-title">
                <b>Lahugala Magul Maha Viharaya </b>
                <h4>
                  Ruins of this temple are one of the major tourist attractions
                  of the eastern province. And this temple is an archeologically
