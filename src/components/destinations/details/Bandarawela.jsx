          ...
          <div className="card-body">
            <p className="card-text">
              <h3>
                ...
                eco – tourism. During the period of British colonial era, the
                town occurred rapid development of the infrastructures and human
              ...
              <h3 className="card-title">
                ...
                <h4>
                  ...
                  Walagamba in the first century BC and is located beside
                  Baddulla - Bandarawella high way 6Km away from Bandarawella
                  city. It has 38ft (12Km) Buddha image sculptured from a rock
                  and some paintings belonging to the Kandyan era.
                </h4>
                <h4>
