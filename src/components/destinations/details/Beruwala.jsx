          ...
          <div className="card-body">
            <p className="card-text">
              <h3>
                ...
                sea and sand. The name Beruwala is derived from the Sinhalese
                word for the place where the sail is lowered. It marks the spot
                for the first Muslim settlement on the island, established by
                Arabian traders around 8th century AD.
                {/* <br/><br/>
              ...
              <h3 className="card-title">
                ...
                <h4>
                  ...
                  kechimalai mosque is built on the spot where the Muslim
                  traders from the Middle East landed. The best time to visit
                  this historic structure would be during the annual celebration
                  marking the end of the month of Ramadan .it is a joyous
                  occasion and visitors to the kechimalai mosque will also enjoy
                  the gorgeous vistas of the ocean and the surrounding areas
                  that one can get from a top the headland.
                </h4>
              </h3>
              ...
              <h3 className="card-title">
                ...
                <h4>
                  ...
                  peaceful ambience, the light house is simply a pleasing
                  addition to this green island known as Barbarian Island.
                </h4>
              </h3>
              ...
              <h3 className="card-title">
                ...
                <h4>
                  ...
                  being the Beruwala light house. All ships and boats going to
                  the Maldives have to pass the Beruwala lighthouse which is
                  among the most important place along the voyage.
                </h4>
              </h3>
            </p>
            {/* <p className="card-text">
