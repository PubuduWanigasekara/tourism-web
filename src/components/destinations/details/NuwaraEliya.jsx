        ...
        <div className="card-body">
          <p className="card-text">
            ...
            <h3 className="card-title">
              ...
              <h4>
                Driving down the winding roads of Nuwara Eliya, away from the main town, there’s a noticeable change in the surrounding area. Thick forests line along the sides of the bendy roads. Seetha Amman Temple is located here, on one of the narrow bends. There’s no proper sign or entrance so it’s most often missed due to its subtlety. The location of the temple is really beautiful. Dense jungles provide a picturesque backdrop behind the vibrant temple. According to Hindu mythology, this is where Princess Seetha was held captive by King Ravana. The bubbly stream is believed to be where Princess Seetha bathed, gushes alongside the temple. The Seetha Amman kovil is a quaint little temple with statues of Rama, Seetha, Hanuman, Lakshmana and Sugriva. Its distinguishing factor is that it is the only Kovil in the world dedicated to the Goddess Seetha.
              </h4>
            </h3>
            ...
            <h3 className="card-title">
              <b>Gregory Lake</b>
              <h4>
                Gregory Lake is located about one kilometer away from Nuwara Eliya town. It was constructed under the period of British Governor Sir William Gregory in 1873. This is the most prominent attraction place in Nuwara Eliya and all the visitors used to come here and spend some time by the lake and relax. This was used as a place for water sports and for recreational activities during the British time. It’s a beautiful experience to see the sun set at one end and the lake at another. It’s a breathtaking view.  You can also go boating and rowing. Also you can go for horse riding around the lake.
              </h4>
            </h3>
            <h3 className="card-title">
              <b>Victoria Park</b>
              <h4>
                The Queen Victoria Park is located by the Nuwara Eliya City center and one of the most visited attraction. This park was named to commemorate the 60th Jubilee Coronation of Queen Victoria in the year 1897. The park covers 27 acres of land. Victoria Park is a place to relax and enjoy the natural sights and clean mountain air. This place is famous for bird watching where bird lovers would spend long hours.  There are large varieties of plants and trees available and also a children park to play.
              </h4>
            </h3>
            ...
            <h3 className="card-title">
              ...
              <h4>
                Mackwoods Labookelle Tea Centre, situated approximately 1500 meters above sea level in the heart of Labookelle Estate, one of the finest tea plantations in Sri Lanka, is today a popular stop in an international travelers itinerary providing an opportunity to experience Mackwoods Tea at its best in the salubrious hill country climate as well as providing an instructive glimpse of the manufacture of Ceylon Tea. The Labookelle Tea Centre which has for long been a popular land mark amongst both locals and tourists to Nuwara-Eliya from Kandy for their requirements of garden fresh high quality tea.
              </h4>
            </h3>
            ...
            <h3 className="card-title">
              ...
              <h4>
                Pedro Tea Estate at Boralanda, 3 km away from city still uses some original machinery and is less commercialized than other estates. There are some very pleasant walks through the plantations here, especially down to the tank and to Bomburu Ella.
              </h4>
            </h3>
            ...
            <h3 className="card-title">
              <b>Ramboda Falls</b>
              <h4>
                Ramboda Falls is located by the small city Pussellawa, the A5 highway ( Pussellawa- Nuwara Eliya road). Ramboda falls consists of three sections. You will get a good view of the middle section from the A5 highway, just above the bridge. This is very small in size with compared to other parts. You can get a far view of the top part from the main road, but not the complete view of the fall. You need to climb up to see the top part of the Ramboda falls and there is a pathway just before the bridge. You may find the climbing bit difficult, but you will be compensated with the great view of the top fall and the surrounding. The bottom part of the Ramboda falls is located under the bridge. If you need to see the full section of the bottom fall, you need to walk down from there to reach the lower waterfall. This is call Ramboda basin.
              </h4>
            </h3>
            ...
            <h3 className="card-title">
              <b>Lover’s Leap</b>
              <h4>
                A young prince and the girl he loved held hands and jumped off the waterfall at the mountain of Piduruthalagala when the soldiers of the king, tried to drag him back to the palace by force. History does not record their names, but since that fateful escapade the waterfall nearby is called Lover’s Leap. To this day, every drop of water that cascades down the sloping rocks to the pool below is a eulogy to their undying love. This is off the Nuwara Eliya – Kandapola Road. The waters are taken to brew the famous Nuwara Eliya Beer.
              </h4>
            </h3>
            ...
            <h3 className="card-title">
              ...
              <h4>
                St. Clair Waterfall can be easily viewed from just 3 km away from the Thalawakele Town, in Hatton - Thalawakele main road (A7 road, Nuwara Eliya - Awissawella Road). The name given, because this fall is located in St. Clair Tea estate.
              </h4>
            </h3>
          </p>
          {/* <p className="card-text">
