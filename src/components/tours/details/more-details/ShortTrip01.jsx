            ...
            <p className="card-text">
              <h3 className="card-title">
                ...
                <h4>
                  ...
                  the Dutch fortified city. Here you can see 17th century
                  fortress bursting with life, quaint shops where you can
                  purchase exquisite handmade lace items. Also you will be
                  visiting Hikkaduwa and around include: National park.
              ...
              <h3 className="card-title">
                ...
                <h4>
                  ...
                  the last day of the tour. And after reaching there you can
                  visit the gem mines and gem museum. Evening returning to
                  Negambo your hotel or Katunayake International Airport to
                  depature. And the tour ends here...
                </h4>
              </h3>
              ...
              <h3 className="card-title">
                ...
                <h4>
                  ...
                  And if you are looking for the real valuable gems I'm sure
                  this trip to gem city will give you a lot of understanding of
                  how that are found and the value of those gems and this trip
                  is surely a perfect choice.
                </h4>
              </h3>
              ...
              <h3 className="card-title">
                ...
                <h4>
                  <ui>
                    ...
                    <li>
                      Watching the native leopards and listening out for big
                      eared elephants in Yala National park.
                    </li>
